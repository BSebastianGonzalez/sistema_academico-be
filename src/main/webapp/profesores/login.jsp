...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/docentes.css">
</head>
<body>
  ...
  <div class="login-card">
    <div class="card-body">
      <div class="text-center mb-4">
        ...
        <h2 class="mt-3">Acceso Docentes</h2>
      </div>
...
<script src="${pageContext.request.contextPath}/js/docentes/login.js"></script>
</body>
</html>
